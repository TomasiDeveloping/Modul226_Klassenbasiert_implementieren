...
public class GuiFischeAuswahlFang {
	...
	public Pane startGuiFischeAuswahlFang() {
		...
		// Ein Hintergrund Bild wird erstellt und übergeben
		...
		Background background = new Background(backgroundImage); // Ein Background wird estellt und das Image mit dem Bild übergene
		...
		//
		// // Button für die Fische werden erstellt
		//
		...
		// Funktion um das Prüf GUI aufzurufen
		...
		aescheButton.setId("Äsche"); // Eine ID wird gesetzt um den Button zu Identifizieren und den ID in ein String umzuwandeln
		...
		//
		// // Label für die Fisch Namen werden ersrellt und überschrift
		//
		...
		Label fischeAuswahlLabel = new Label("Fangmethode für den Fisch wählen:"); // Das Label wird mit dem Namen erstellt
	...
	public void startGuiFangmethode(Button button) {
		button.setOnAction((event) -> {
		// Ein String wird erstellt und die Button ID übergeben
		String string = button.getId();
		GuiFangmethode startGuiFangmethode = new GuiFangmethode(this.main);
		main.getScene().setRoot(startGuiFangmethode.startGuiFangmethode(string)); // Der String wird übergeben das das GUI mit der gewählten Einsetllung gestartet wird	
	});
	}
